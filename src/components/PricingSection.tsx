...
const PricingSection = ({ lang }: { lang: "ar" | "en" }) => {
  ...
  const handleTrialClick = (planName: string) => {
              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    className={`w-full text-center font-bold py-4 rounded-xl transition-all duration-200 text-base active:scale-95 cursor-pointer ${
                      isPopular
